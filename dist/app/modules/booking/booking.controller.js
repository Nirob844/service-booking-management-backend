...
const insertIntoDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield booking_service_1.BookingService.insertIntoDB(
      userId,
      req.body
    );
...
const getDataById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { userId, role } = req.user;
    const result = yield booking_service_1.BookingService.getDataById(
      req.params.id,
      userId,
      role
    );
...
const updateOneInDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield booking_service_1.BookingService.updateOneInDB(
      id,
      req.body
    );
    (0, sendResponse_1.default)(res, {

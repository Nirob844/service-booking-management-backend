...
const insertIntoDB = (userId, data) => __awaiter(void 0, void 0, void 0, function* () {
    data.userId = userId;
    const { bookingServices } = data, bookingData = __rest(data, ["bookingServices"]);
    const newBooking = yield prisma_1.default.$transaction((transactionClient) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (bookingServices && bookingServices.length > 0) {
            yield (0, utils_1.asyncForEach)(bookingServices, (bookingData) => __awaiter(void 0, void 0, void 0, function* () {
...
const getDataById = (BookingId, userId, role) => __awaiter(void 0, void 0, void 0, function* () {
    let Booking = null;
    if (role === 'admin') {

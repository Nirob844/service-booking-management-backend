...
router.get(
  ...
  addCart_controller_1.AddCartController.getAllFromDB
);
router.post(
  '/',
  (0, auth_1.default)(user_1.ENUM_USER_ROLE.CUSTOMER),
  addCart_controller_1.AddCartController.insertIntoDB
);
router.patch(
  '/:id',
  (0, auth_1.default)(
  ...
  addCart_controller_1.AddCartController.updateOneInDB
);
router.delete(
  '/:id',
  (0, auth_1.default)(
  ...
  addCart_controller_1.AddCartController.deleteByIdFromDB
);

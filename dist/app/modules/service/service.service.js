...
const getAllFromDB = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { searchTerm, minPrice, maxPrice, status } = filters, filterData = __rest(filters, ["searchTerm", "minPrice", "maxPrice", "status"]);
    const andConditions = [];
    if (searchTerm) {
        andConditions.push({
...
const getDataByCategoryId = (categoryId, options) => __awaiter(void 0, void 0, void 0, function* () {
    const { limit, page, skip } = paginationHelper_1.paginationHelpers.calculatePagination(options);
